<x-layout-admin>
    ...
    <div class="d-flex align-items-center justify-content-between">
        ...
        @if ($pekerjaan['id_status'] == 1)
            <a href="/request" class="badge badge-warning">
            @elseif ($pekerjaan['id_status'] == 3)
                <a href="/ongoing" class="badge badge-warning">
                @elseif ($pekerjaan['id_status'] == 4)
                    <a href="/history" class="badge badge-warning">
        @endif
        <h5>
                ...
                <div class="col-xl-3 col-lg-5">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            @if ($pekerjaan['id_status'] == 1)
                                <div class="mb-2">
                                    <form action="{{ route('pekerjaan.accept', $pekerjaan->id_pekerjaan) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
                                ...
                                <div>
                                    <form action="{{ route('pekerjaan.reject', $pekerjaan->id_pekerjaan) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
